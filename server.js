...
io.on('connection', (socket) => {
  ...
  socket.on('game:move', (data) => {
    ...
    } else if (room.gameType === 'applegame') {
      handleAppleGameMove(socket, room, role, data);
    }
  });
...
function handleAppleGameMove(socket, room, role, { row1, col1, row2, col2 }) {
