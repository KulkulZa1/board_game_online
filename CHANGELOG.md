...
- Factory arcade now prevents dead miner placements, adds delivery milestone feedback, improves mobile palette/tool layout, and is covered by the deep smoke-check route/policy assertions.
