...
- Factory arcade now prevents dead miner placements, adds delivery milestone feedback, autosaves/restores factory layouts, improves mobile palette/tool layout, and is covered by the deep smoke-check route/policy assertions.
