    ...
    },
    {
      ...
      rules: {
        ...
        sections: [
          ...
          { head: '장목 금지', text: '6개 이상 연속은 승리로 인정되지 않습니다 (흑·백 모두). 3·3 같은 금수는 없습니다.' },
    ...
    },
    {
      ...
      rules: {
        ...
        sections: [
          ...
          { head: '색상', text: '빨강이 먼저 둡니다. 첫 판은 호스트가 빨강이고, 재대국 때는 서로 색을 바꿉니다.' },
        ]
      }
    },
    {
    ...
    },
    {
      ...
      rules: {
        ...
        sections: [
          ...
          { head: '배팅', text: '게스트가 먼저 배팅합니다. 상대의 레이즈를 콜로 맞추면 베팅이 끝나고 쇼다운으로 갑니다.' },
          { head: '액션', text: '• 콜: 상대 배팅에 맞춤\n• 레이즈: 상대 배팅을 맞추고 5칩 더 (최대 3회)\n• 폴드: 포기, 상대방 승리\n⚠️ 10을 가지고 폴드하면 앤티만큼 추가 칩 손실!' },
          { head: '동점', text: '같은 숫자면 팟을 반씩 나눕니다 (홀수 칩은 먼저 배팅한 쪽).' },
    ...
    },
    {
      ...
      rules: {
        ...
        sections: [
          ...
          { head: '선공', text: '빨강이 먼저 둡니다. 재대국 때는 서로 색을 바꿉니다.' },
        ]
      }
    },
    {
    ...
    },
    {
      ...
      rules: {
        ...
        sections: [
          ...
          { head: '선공', text: '백(하단)이 먼저 둡니다. 재대국 때는 서로 색을 바꿉니다.' },
        ]
      }
    },
  ];
