...
| Reaction-time / rhythm tap | Solo first | Very quick play, touch-native, easy replay loop | Timing map, target pattern, difficulty curve | Low-Medium | Good arcade candidate after shared result screen |
